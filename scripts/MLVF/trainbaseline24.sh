...
BASE_MODEL_NAME=MobileLLaMA-1.4B-Chat
...
LAYER_USING_STRATEGY="${LAYER_USING_STRATEGY:-24}"
...
MODEL_PATH="/publicssd/share/h13599/MobileLLaMA-1.4B-Chat"
...
deepspeed --master_port $MASTER_PORT --include localhost:4,5,6,7 llava/train/train.py \
